...
public class StatisticUtils {
	 ...
	 */
	public static String meanWithCofidenceInterval(StatisticalSummary statistics, double significance, String format) {
	 ...
	 */
	public static String meanWithCofidenceIntervalPercent(StatisticalSummary statistics, double significance,
			String format) {
	...
	public static double getConfidenceIntervalDelta(StatisticalSummary stats, double significance) {
		...
		Preconditions.checkArgument(stats.getN() > 0);
		if (stats.getN() == 1) {
			return 0.0;
		}
