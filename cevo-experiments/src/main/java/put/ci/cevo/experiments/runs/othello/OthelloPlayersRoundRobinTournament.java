...
public class OthelloPlayersRoundRobinTournament implements Experiment {
	private static Logger logger = Logger.getLogger(OthelloPlayersRoundRobinTournament.class);
	...
	public void run(String[] args) {
		...
		players.add(new Pair<String, OthelloPlayer>("EM10_Nash70", new Manning2010Nash70Player().create()));
		players.add(new Pair<String, OthelloPlayer>("EM10_TCIAG2", new Manning2010TCIAG2Player().create()));
		players.add(new Pair<String, OthelloPlayer>("EM10_TCIAG1", new Manning2010TCIAG1Player().create()));
		players.add(new Pair<String, OthelloPlayer>("EM10_GECCO", new Manning2010GECCOPlayer().create()));
		...
		players.add(new Pair<String, OthelloPlayer>("CMAES-4-2x2", new JaskowskiSzubert2015CoCMAES4_2x2Player().create()));
		//players.add(new Pair<String, OthelloPlayer>("CMAES-4", new JaskowskiSzubert2015CoCMAES4Player().create()));
		//players.add(new Pair<String, OthelloPlayer>("CMAES-3", new JaskowskiSzubert2015CoCMAES3Player().create()));
		//players.add(new Pair<String, OthelloPlayer>("CMAES-2", new JaskowskiSzubert2015CoCMAES2Player().create()));

		//players.add(new Pair<String, OthelloPlayer>("WJ_All2", new Jaskowski2014All2Player().create()));
		//players.add(new Pair<String, OthelloPlayer>("WJ_All123", new Jaskowski2014All123Player().create()));
	...
	public static void main(String[] args) {
		new OthelloPlayersRoundRobinTournament().run(args);
	}
